<div class="card">
  <div class="card-header">
    <h3 class="card-title">Thông tin thực phẩm</h3>
  </div>
  <!-- /.card-header -->
  <div class="card-body">
      ...
      <tbody>
        ...
        foreach ($foods as $item) {
          ...
          <tr>
            ...
            <td><?=Categoryfood::getName($item->categoryid) ?></td>
            <td>
              <div class="btn-group">
                ...
                <div class="dropdown-menu" role="menu">
                  <a class="dropdown-item" href="index.php?controller=foods&action=edit&id=<?= $item->id ?>"><i
                      class="fas text-primary fa-pencil-alt pr-1"></i>Cập nhật</a>
                  <a class="dropdown-item remove" href="index.php?controller=foods&action=remove&id=<?= $item->id ?>"><i
  ...
  $(function () {
    ...
    $("#example1").DataTable({
      ...
      "buttons": [{
        text: "Thêm",
        action: function () {
          window.location = "index.php?controller=foods&action=edit";
        }
      }],
      "aoColumnDefs":[
